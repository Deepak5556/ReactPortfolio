    ...
    <footer className="bg-gray-50 py-12">
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div className="flex flex-col items-center">
          <div className="mb-6">
            <h2 className="text-2xl font-semibold text-primary">Deepakkumar.</h2>
          </div>
          ...
          <div className="flex gap-6 mb-8">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center hover:text-primary transition-colors">
              <Dribbble size={20} />
            </a>
          ...
          <div className="text-center text-gray-500 text-sm">
            <p>Copyright &copy; {new Date().getFullYear()} <span className="text-primary">Deepakkumar</span> - All rights reserved</p>
          </div>
        </div>
      </div>
    </footer>
