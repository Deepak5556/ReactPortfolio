    ...
    <footer className="bg-gray-50 py-12">
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div className="flex flex-col items-center">
          ...
          {/* Social Media Icons */}
          <div className="flex gap-6 my-8" role="navigation" aria-label="Social media links">
            <a
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Visit Deepakkumar’s Dribbble profile"
              className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center hover:text-primary transition-colors"
            >
          ...
          <div className="text-center text-gray-500 text-sm">
            ...
            <p>
              ...
              <span className="text-primary">Deepakkumar</span> - All rights reserved
            </p>
          </div>
